<main
    class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-base-200 min-h-screen transition-all main flex flex-col md:flex-row md:justify-evenly items-center active">
    <div class="bg-base-300 px-10 pb-5 min-w-[350px] lg:min-w-[400px] my-8 h-2/5 min-h-[360px]">
        ...
        <form id="admin-form" action="/loginpage/src/requests/auth/newUser.php" method="post"
            class="h-3/5 flex flex-col justify-evenly max-w-[500px] w-full">
            <input type="hidden" name="role" value="admin">
            <div class="h-1/4">
                <label
                    class=" h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["admin"]["fullname"]) ? "" : "input-error" ?>">
            ...
            <div class="h-1/4">
                <label
                    class="h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["admin"]["email"]) ? "" : "input-error" ?>">
            ...
            <div class="h-1/4">
                <label
                    class="h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["admin"]["username"]) ? "" : "input-error" ?>">
            ...
            <div class="h-1/4">
                ...
                <label
                    class="h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["admin"]["password"]) ? "" : "input-error" ?>">
    ...
    <div class="bg-base-300 px-10 pb-5 min-w-[350px] lg:min-w-[400px] h-2/5 min-h-[360px]">
        ...
        <form id="client-form" action="/loginpage/src/requests/auth/newUser.php" method="post"
            class="h-1/2 flex flex-col justify-evenly max-w-[500px] w-full">
            <input type="hidden" name="role" value="client">
            <div class="h-1/4">
                <label
                    class="h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["client"]["fullname"]) ? "" : "input-error" ?>">
                    <i class="fa-solid fa-id-card fa-sm" style="opacity: 0.7;"></i>
                    <input name="fullname" type="text" class="grow" placeholder="Full Name"
                        pattern="^(\w\w+)\s(\w+)$" />
                </label>
            ...
            <div class="h-1/4">
                <label
                    class="h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["client"]["email"]) ? "" : "input-error" ?>">
                    <i class="fa-solid fa-envelope"></i>
            ...
            <div class="h-1/4">
                <label
                    class="h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["client"]["username"]) ? "" : "input-error" ?>">
                    <i class="fa-solid fa-user"></i>
                    <input name="username" type="text" class="grow" placeholder="Username" minlength="5" />
                </label>
            ...
            <div class="h-1/4">
                <label
                    class="h-3/5 input input-bordered flex items-center gap-2 <?php echo empty($_SESSION["errors"]["client"]["password"]) ? "" : "input-error" ?>">
                    <i class="fa-solid fa-key"></i>
                    <input name="password" type="password" class="grow" placeholder="********" minlength="8" />
                </label>
